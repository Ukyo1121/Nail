...
from train_classification import MultiTaskEfficientNetB0, loss_function, calculate_correct
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='./work_dir/models/classification_new/V1/mobilenet_classification_best.pth', help="Path to trained .pth model")
    ...
    parser.add_argument('--old_val_ann', type=str, default='/home/suzhiling/efficientnet/annotations/val_classification_B.json', help="Path to old validation annotation file (optional, for concatenation)")
    parser.add_argument('--old_val_dir', type=str, default='/data/zhangxiaohao/dazhouV2/Bclass/batch1/output/val', help="Path to old validation image directory (optional, for concatenation)")
